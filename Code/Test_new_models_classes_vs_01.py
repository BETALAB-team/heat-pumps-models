...
def barplot(KPI):
    ...
    plt.tight_layout()
    # plt.savefig(os.path.join('..',"Result Analysis","New_Models_KPI_weight_Carnot.png"))
    # plt.close()
    ...
    plt.tight_layout()
    # plt.savefig(os.path.join('..',"Result Analysis","SCOP_weight_Carnot.png"))
    # plt.close()
    
#%% Devices lists

devices = [
           ("Valliant A+ 5kW  ID5 01-11-2022_28-02-2023", "Valliant Aerotherm plus  VWL 55-6  A S3 5 kW - DATA"),
           ("Valliant A+ 5kW  ID9 01-11-2022_28-02-2023", "Valliant Aerotherm plus  VWL 55-6  A S3 5 kW - DATA"),
           ("Valliant A+ 5kW  ID24 01-11-2022_28-02-2023", "Valliant Aerotherm plus  VWL 55-6  A S3 5 kW - DATA"),
