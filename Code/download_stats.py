...
#Filter
# heatpumps = heatpumps.loc[
#                             # (heatpumps["hp_model"] != "Mitsubishi Ecodan") & 
#                           (heatpumps["hp_model"] != "Vaillant Arotherm+")
#                           (heatpumps["hp_model"] != "Daikin Altherma 3") &
#                           (heatpumps["hp_model"] != "Samsung Gen 6") 
                            # ]


# heatpumps = heatpumps.loc[heatpumps["hp_model"] == "Nibe F2050"]
# heatpumps = heatpumps.loc[heatpumps["hp_model"] == "Daikin Altherma 3"]
# heatpumps = heatpumps.loc[heatpumps["hp_model"] == "NIBE F2040"]
...
# running_elec_kwh, running_heat_kwh, running_cop, running_data_length, running_elec_mean, running_heat_mean, run   ning_flowT_mean, running_returnT_mean, running_outsideT_mean, running_roomT_mean, running_prc_carnot
